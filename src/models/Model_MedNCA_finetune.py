...
class MedNCA_finetune(nn.Module):
    ...
    def forward(self, x: torch.Tensor, y: torch.Tensor = None, variance = None, pred = None, return_channels : bool = False):
        ...
        if self.training:
            ...
            x, y, variance, pred, inputs_loc = self.forward_train(x, y, variance, pred, return_channels=return_channels)
    ...
    def forward_train(self, x: torch.Tensor, y: torch.Tensor, variance: torch.Tensor, pred: torch.Tensor, return_channels : bool = False):
